...
::: tip 提示主题组件受到同样的 [浏览器的 API 访问限制](./using-vue.md#浏览器的-api-访问限制)。 :::
...
::: tip 提示 `lastUpdated` 是这个文件最后一次 git 提交的 UNIX 时间戳，更多细节请参考：[最后更新时间](../default-theme-config/README.md#最后更新时间)。 :::
